...
<body>
	...
	<div id="main">
		<div id="header">
			<h2>WebSocket <small>홍길동</small></h2>
		</div>
		<div id="list"></div>
		<input type="text" id="msg" placeholder="대화내용을 입력하세요.">
	</div>
		...
		*/
		...
		function connect(name){
			...
			ws.onopen = function(evt){
				...
				//메시지 규칙
				//ws.send('1|홍길동')			//상태코드|본인 대화
				//ws.send('2|1|2|홍길동')		//상태코드|보내는사람|받는사람|대화
