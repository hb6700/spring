...
<style>
	 ...
	 table tr : neth-child(1) td:nth-child(2) {width: 150px;}
	 table tr : nth-child(3) td {height:100px;}
	 table tr : nth-child(4) img {display:block; border:1px solid #ccc; border-radius: 3px; padding:5px; margin:15px auto; max-width: 700px;}
	 
	 #map{width: 700px; height: 500px; margin:15px auto; border:1px solid #ccc; border-radius: 3px;}
</style>
</head>
<body>
	<!-- view.jsp -->
	...
	<script>
		<c:if test="${not empty lat}">
			...
			const options = {
				center: new kakao.maps.LatLng(37, 132),
				level: 3
			}
